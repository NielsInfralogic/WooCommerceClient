...
namespace WooCommerceClient.Models.Base
{
    [DataContract]
        ...
        void OnSerializing(StreamingContext ctx)
        {
            foreach (PropertyInfo pi in GetType().GetRuntimeProperties())
            {
                ...
                if (objValue != null && pi.GetValue(this) != null)
                {
                    ...
                    {
                        if (1==1 || GetType().FullName.StartsWith("WooCommerceNET.WooCommerce.v1") ||
...
#pragma warning disable CS0693 // Type parameter has the same name as the type parameter from outer type
        public async Task<T> Add<T>(T item, Dictionary<string, string> parms = null) 
...
#pragma warning disable CS0693 // Type parameter has the same name as the type parameter from outer type
        public async Task<T> Update<T>(int id, T item, Dictionary<string, string> parms = null)
#pragma warning restore CS0693 // Type parameter has the same name as the type parameter from outer type
        {
...
#pragma warning disable CS0693 // Type parameter has the same name as the type parameter from outer type
        public async Task<T> Add<T>(T item, int parentId, Dictionary<string, string> parms = null)
#pragma warning restore CS0693 // Type parameter has the same name as the type parameter from outer type
        {
...
#pragma warning disable CS0693 // Type parameter has the same name as the type parameter from outer type
        public async Task<T> Update<T>(int id, T item, int parentId, Dictionary<string, string> parms = null)
#pragma warning restore CS0693 // Type parameter has the same name as the type parameter from outer type
        {
